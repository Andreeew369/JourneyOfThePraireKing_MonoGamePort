...
/// <summary>
/// Class that represents an enemy in the game. It's base class for all enemies in the game and all enemies
/// in game should inherit from this class
/// </summary>
public abstract class Enemy : GameObject {
    ...
    /// <return>True if the enemy is going to collide with other enemy</return>
    ...
    /// <param name="enemies">List of all enemies in the current game</param>
    /// <returns>True if the enemy is going to collide with other enemy</returns>
    ...
    public (float xDir, float yDir) GetDirTo(Player player) => GetDirTo((player.X, player.Y));
}

/// <summary>
/// Enum that represents state of the enemy
/// </summary>
...
/// <summary>
/// Enum that represents type of the enemy
/// </summary>
...
public static class EnemyTypeMethods {
    ...
    /// <exception cref="NotImplementedException">If new enemy is implemented and return type is not defined for this case</exception>
