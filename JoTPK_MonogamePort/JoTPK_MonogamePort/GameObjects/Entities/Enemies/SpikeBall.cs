...
/// <summary>
/// Enemy, which doesn't follow a player like other enemies,
/// but moves to a random target and after reaching it, turns into a ball
/// </summary>
public class SpikeBall : Enemy {
    ...
    public SpikeBall(int x, int y, Level level) : base(x, y, EnemyType.SpikeBall, level) {
    ...
    /// <summary>
    /// Set parameters of a Spikeball enemy so its turns into a ball (turn into immovable Spikeball)
    /// </summary>
