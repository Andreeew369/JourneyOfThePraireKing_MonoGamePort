...
/// </summary>
public class SmokeBomb : GameObject, IPowerUp {
    ...
    public override void Draw(SpriteBatch sb) => TextureManager.DrawObject(GameElements.SmokeBomb, RoundedX, RoundedY, sb);
